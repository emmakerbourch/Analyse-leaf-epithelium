...
def segmentation_group1(fnames):
    ...
    #remove_small_holes
    mask_process_hole = morphology.remove_small_holes(mask_process.astype(bool), 7000)

    #remove_small_objects
    final_mask = skimage.morphology.remove_small_objects(mask_process_hole, 0)
